...
function Contact() {
  ...
  return (
    <Motion>
      <div
        ref={contactRef}
        className="flex p-8 w-[90vw] lg:h-[100vh] rounded-3xl lg:flex-row m-auto flex-col items-center gap-6 bg-gradient-to-bl from-[var(--dark-purple)] to-[var(--light-purple)]"
        id="contact"
      >
