...
function Explore() {
  ...
  return (
    <Motion className="my-[120px]">
      <div className="flex flex-col md:flex-row mx-auto w-[85vw] text-center justify-center items-center md:items-start gap-6">
        <div className="flex flex-col  gap-4">
          <h1 className="lg:text-4xl text-3xl font-semibold  text-center mt-4">
            Discover useful advice on{" "}
            <span className="text-blue-800">Career</span> paths
          </h1>
